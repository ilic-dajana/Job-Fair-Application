...
/**
 * DatumZaSajam generated by hbm2java
 */
@Entity
@Table(name="datumZaSajam"
    ,catalog="job_fair"
)
public class DatumZaSajam  implements java.io.Serializable {
    ...
    public DatumZaSajam(int id, Date datumPocetak, Date datumKraj) {
       this.id = id;
